...
export default function Auth() {
  ...
  <div className={"row flex-center flex"}>
    <div className="col-7 form-widget" aria-live="polite">
      <h1 className="font-sans text-4xl text-center py-2 mx-1">Company's ToDo List</h1>
      <span className="font-sans text-2xl text-center pb-2 mb-1 border-b mx-4 align-center">
          Login with your company's email
      </span>
      <label
      ...
      <input
          className={"bg-gray-100 border text-black py-1 px-3"}
          type={"email"}
          name={"email"}
          ref={emailRef}
          required
      ...
      <input
          className={"bg-gray-100 text-black border py-1 px-3"}
          type={"password"}
          name={"password"}
          ref={passwordRef}
          required
